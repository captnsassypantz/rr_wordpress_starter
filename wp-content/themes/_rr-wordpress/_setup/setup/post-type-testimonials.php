...
add_action( 'init', 'RegisterCPT_Testimonials' );
function RegisterCPT_Testimonials() {
...
function testimonial_title( $title ){
     $screen = get_current_screen();
 
     if  ( 'testimonials' == $screen->post_type ) {
          $title = 'Enter the testimonial writers name here';
     }
 
     return $title;
}
add_filter( 'enter_title_here', 'testimonial_title' );
