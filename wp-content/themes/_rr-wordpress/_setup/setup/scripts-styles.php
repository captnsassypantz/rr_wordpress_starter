...
function brandco_enqueue_scripts_styles() {
	...
	wp_enqueue_script('flexslider', get_template_directory_uri() . '/_assets/scripts/scripts/flexslider.min.js', array('jquery'), null, true);

	# Styles
	wp_register_style( 'bcore-google-font', 'https://fonts.googleapis.com/css?family=Nunito:400,700');
	wp_enqueue_style( 'brandco-theme-style', get_template_directory_uri() . '/_assets/styles/brandco.min.css' );
	// wp_enqueue_style( 'brandco-theme-style', get_template_directory_uri() . '/_assets/styles/header-footer.min.css' );
	wp_enqueue_style( 'bcore-google-font' );	
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/_assets/fonts/font-awesome-4.4.0/css/font-awesome.min.css' );
}
